                ...
                <ol class="list-group list-group-numbered" style="margin-top:20px">
                    <li class="list-group-item d-flex justify-content-between align-items-start">
                        <div class="ms-2 me-auto menu-cat">
                            <div class="fw-bold">Dokumen Sertifikat</div>
                                <div class="show-item-1" style="display:none">
                                    <div>- Sertifikat Tanah <span class="badge bg-primary rounded-pill">14</span></div>
                                    <div>- Sertifikat Pendirian <span class="badge bg-primary rounded-pill">14</span></div>
                                </div>
                        </div>
